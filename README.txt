...
a persistence unit "FrontofficeLab2023PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "FrontofficeLab2023/pom.xml":
...
artifacts ("FrontofficeLab2023-ejb.jar" and "FrontofficeLab2023-web.war") are already built. You can build
